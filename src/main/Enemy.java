...
public class Enemy extends Entity {
    ...
    // ====== Enemy Values ======
    protected SharkAction enemyAction = RUNNING;
    ...
    protected void updateSharkAnimationTick() {
        ...
        if (animationTick >= ANIMATION_SPEED) {
            ...
            if (animationIndex >= getSharkSpriteAmount(enemyAction)) {
                animationIndex = 0;
    ...
    protected void setAction(EnemyConstants.SharkAction enemyAction) {
    ...
    public SharkAction getEnemyAction() {
        return enemyAction;
    }
